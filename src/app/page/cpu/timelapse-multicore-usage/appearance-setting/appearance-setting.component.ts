...
export class AppearanceSettingComponent {
  ...
  @Output() chart_colorChange: EventEmitter<string> = new EventEmitter<string>();

  public demo_x_scale = 1;
  public demo_y_scale = 1;
  public demo_chart_color!: string;
  ...
  constructor(private update_notifier: CpuDataUpdateNotifierService){}

  ngOnInit(){
    this.demo_x_scale = this.x_scale;
    this.demo_y_scale = this.y_scale;
    this.demo_chart_color = this.chart_color;
  }
  ...
  public set_chart_color(new_color: string){
    ...
    this.demo_chart_color = new_color;
  ...
  public apply_changes(){
    ...
    this.chart_colorChange.emit(this.demo_chart_color);
  }
